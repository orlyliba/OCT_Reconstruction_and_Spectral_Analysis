...
balanceFunc.power = 5;
balanceFunc.autoROI = 1;%1;
balanceFunc.exclude_vessels = 1;%1;
...
frames2Avg3D = 6; % averaging of frames at different locations
additionalFrameAvgOverlap = 0; % on every side
%% specific display parameters
diffScale = 700;%0.4; % ext
diffNormScale = 0.0008;%0.4;
thrSpeckVar = 0.1;
maxSpeckVar = 1.0;
