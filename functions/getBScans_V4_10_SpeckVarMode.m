function [xml_header, params, interfAll, avgLogBscan, linBscan, BscansCpx, apodization, timeStamp] = getBScans_V4_10_SpeckVarMode(fileAndPath,xml_header,chirpVect,dispComp,frameRange,filt)
...
if  isfield(xml_header.Acquisition,'SpeckleAveraging') && isfield(xml_header.Acquisition.SpeckleAveraging,'SlowAxis')
